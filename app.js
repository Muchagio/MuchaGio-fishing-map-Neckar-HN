...
const APP_VERSION=data?.meta?.version||'1.1.1';
...
function initMap(){
  ...
  async function loadMapData(){
    ...
    setRuntimeStatus(`GIS aktiv: ${waterLoaded}/${data.osmWaterSources.length} Gewässerbereiche vollständig aus den gefundenen OSM-Wasserwegen geladen; keine harte Kürzung an Bounding-Box-Kanten. ${structuresShown} verifizierte Bauwerke angezeigt; ${structuresHidden} unsichere Punkte ausgeblendet. Nur Bauwerke mit veröffentlichter Distanzregel erhalten einen Prüfbereich.`,waterLoaded===data.osmWaterSources.length?'ok':'warning');
